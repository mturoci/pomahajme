        ...
        <div class="flex flex-col md:flex-row h-screen">
            ...
            <div class="md:w-1/4 bg-white/10 backdrop-blur-sm p-6 overflow-y-auto">
                ...
                <div class="flex items-center mt-4">
                    ...
                    <span class="text-gray-400 mr-2">Album:</span>
                ...
                <div class="flex items-center mt-3">
                    ...
                    <span class="text-gray-300">{{ $campaign->campaign_date->format('d.m.Y') }}</span>
                </div>
                
                @if ($image->description)
                    <div class="mt-6 border border-white/10 p-4 rounded-lg">
                        <h3 class="text-gray-300 font-medium mb-2">Popis fotografie:</h3>
