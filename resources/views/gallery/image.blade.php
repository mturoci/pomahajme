        ...
        <div class="flex flex-col md:flex-row h-screen">
            <div class="relative flex-grow bg-black md:w-3/4">
                ...
                <div class="absolute inset-y-0 left-0 flex items-center">
                    @if ($prevImage)
                        <a href="{{ url('/galeria/' . $album->id . '/image/' . $prevImage->id) }}" 
                ...
                <div class="absolute inset-y-0 right-0 flex items-center">
                    @if ($nextImage)
                        <a href="{{ url('/galeria/' . $album->id . '/image/' . $nextImage->id) }}" 
            ...
            <div class="md:w-1/4 bg-white/10 backdrop-blur-sm p-6 overflow-y-auto">
                ...
                <div class="flex items-center mt-8">
                    ...
                    <a href="{{ url('/galeria/' . $album->id) }}" class="text-primary hover:underline">
                        {{ $album->title }}
                    </a>
                </div>
                ...
                <div class="flex items-center mt-3">
                    ...
                    <span class="text-gray-200">{{ $album->campaign_date->format('d.m.Y') }}</span>
                </div>
