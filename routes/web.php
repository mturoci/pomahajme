...
Route::get('/euro-nadeje', function() { return view('euro'); });
Route::get('/kontakt', function() { return view('contact'); });
Route::get('/admin', [StoryController::class, 'indexAdmin'])->middleware('auth');
Route::get('/admin/login', function() { return view('login'); });
Route::get('/admin/pribeh', function() { return view('admin-story', ['title' => 'Pridať príbeh', 'btn' => 'Vytvoriť']); })->middleware('auth');
